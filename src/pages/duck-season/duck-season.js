define(['knockout', 'underscore', 'text!./duck-season.html', 'ExploreRequest','Feed-Post', 'infiniteScroll', 'scroll-loader'], function(ko, _, template, ExploreRequest, FeedPost, infiniteScroll, scrollLoader) {
	function UserPosts(params) {

		var post = this;

		post.drawerContents = ko.observable(); // initially blank; pass HTML markup wrapped with ''
		post.pageTitle = ko.observable('Duck-Season at Hembow');
